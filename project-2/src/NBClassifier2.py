...
class NBClassifier2():
    ...
    def train(self, train_df):
        ...
        for language in languages:
            ...
            for row in train_df:
                ...
                char_tweet = utils2.to_char_list(t, self.vocab)
    ...
    def predict(self, test_df):
        ...
        for t in test_df:
            if self.V in [0, 1]:
                test_tweet = utils2.to_char_list(t['tweet'], self.vocab)
            else:
                test_tweet = utils2.to_char_list(t['tweet'], self.vocab, use_alpha=True)
            lang_probs = {}
